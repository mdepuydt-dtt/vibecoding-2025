# Personal Blog App
![Personal Blog](personal-blog.png)

## Features Overview
This personal blog application provides a complete blogging experience with the following features:
- **📝 Blog Post Display** - Browse and read blog posts with full content, author info, and publication dates
- **🏷️ Category Filtering** - Filter posts by categories (Technology, Design, Backend, etc.) with dynamic category buttons
- **📖 Detailed Post View** - Individual post pages with full content, tags, and metadata

# Getting Started - Copilot
- Navigate to the folder of the app: `cd personal-blog`
...
- Change the app into something else (e.g instead of a Personal Blog, make it into a Poetry platform)
